<?php 
  ...
  $tituloPagina = 'Livraria Power - Loja';
  ...
  $statement->fetch();  
	...
	echo "<p class='titulo'>Seja bem-vindo, $cliente! Se você não for $cliente, clique 
        <a href='logout.php'>aqui</a> para sair do sistema e logar como outro usuário.</p>";	
  ...
  if ($linhas == 0) {
    ...
    echo "<div class='pesquisa'>                    
            <form action='loja.php' method='POST'>
              <select name='tipoPesquisa'>
                <option value='a' selected='true'>Autor</option>
    ...
    echo "<h2 class='titulo'>Categorias disponíveis:</h2>
